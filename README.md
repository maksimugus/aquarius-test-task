...
4. Далее считаем, что файлы пронумерованы в алфавитном порядке и их N. Необходимо сгенерировать JSON файл по следующим правилам:
   ...
   - Далее в зависимости от значения **action** в конфигурации:
     ...
     - Если **replace**, то далее как в пункте **string**, но в строках надо поменять буквы 'a' на 1 + номер файла, 'b' на 2 + номер файла, 'c' на 3 + номер файла. Все остальное также
...
- Формат: JSON
- Конфигурации перечислены в виде массива